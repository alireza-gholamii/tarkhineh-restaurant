...
const TarkhinehGardi = () => {
    return (
        <div className='flex flex-col mt-12 '>
            ...
            <div className='flex flex-row m-[0_4vw] h-[400px]'>
...
const Branch = ({img , name , address, gallery}) => {
    return (
        <div className={`relative group grid m-[15px_auto] bg-white fontEstedad w-[20vw] h-[360px] rounded-lg border-solid border-[#417F56] border-[1px]`}>
            <img className="" alt='picture' src={img}/>
            <img  className='hidden group-hover:block absolute top-[25%] right-[45%]' src={gallery} alt="picture"/>
            <div className=''>
                ...
                <a href='#' className={`hidden group-hover:flex justify-center items-center text-xs m-[0_auto] mb-4 w-[10vw] h-9 text-[#315F41] rounded border-solid border-[#417F56] border-[1px]`}>صفحه شعبه <img className='w-4' src={arrow} alt='arrow' /></a>
            </div>
            </div>
    )
}
